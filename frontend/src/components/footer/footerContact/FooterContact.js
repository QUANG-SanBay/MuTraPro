...
function FooterContact({ settings }) {
    const contactEmail = settings?.contactEmail || 'contact@mutrapro.com';
    const supportPhone = settings?.supportPhone || '1900-xxxx';
    
    // Format phone for tel: link (remove spaces and dashes)
