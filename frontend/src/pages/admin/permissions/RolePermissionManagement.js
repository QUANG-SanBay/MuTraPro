                ...
                <div className={styles.roleSelection}>
                    ...
                    <div className={styles.roleGrid}>
                        {managedRoles.map(role => (
                            <div
                                key={role.value}
                                className={`${styles.roleCard} ${styles[role.color]} ${
                                    selectedRole?.value === role.value ? styles.selected : ''
                                }`}
                                    ...
                                    {getFilteredAvailable().map(permission => (
                                        <div
                                            ...
                                            className={`${styles.permissionItem} ${
                                                selectedAvailable.includes(permission.codename) ? styles.selected : ''
                                            }`}
                                ...
                                <div className={styles.permissionList}>
                                    {getFilteredChosen().map(permission => (
                                        <div
                                            key={permission.codename}
                                            className={`${styles.permissionItem} ${
                                                selectedChosen.includes(permission.codename) ? styles.selected : ''
                                            }`}
